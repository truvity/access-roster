...
// workspaces it holds credentials for, and its settings. It is served on
// the console listener only, behind the gateway's authentication; the
// roles come from the identity provider's groups claim (viewer reads,
// operator writes).
